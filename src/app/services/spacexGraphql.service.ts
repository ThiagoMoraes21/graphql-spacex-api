...
export type LauchDetailsQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type LauchDetailsQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LauchDetailsDocument = gql`
    query lauchDetails($id: ID!) {
  launch(id: $id) {
    id
    mission_name
    details
  ...
  export class LauchDetailsGQL extends Apollo.Query<LauchDetailsQuery, LauchDetailsQueryVariables> {
    document = LauchDetailsDocument;
